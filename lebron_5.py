# factors to consider: back to back, opponents facing, injuries, home and away, contract year, losing on purpose, all star players or only mvp， opponent rating for his position, importance of the game
...
df = pandas.read_csv('whole_data_lebron.csv')
