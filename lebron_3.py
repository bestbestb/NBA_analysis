...
# TODO: create a new opponent list with integers representing each team for each year.
# that is, append a new column "opponent's rating to each match of each year